...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Мини‑приложение для аренды недвижимости, связь с риелтором и помощь в оформлении сделки.',
    images: [{ url: '/projects/GRE/01.webp' }],
    type: 'article',
  },
};
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white text-slate-900 dark:bg-gray-900 dark:text-white">
      ...
      <main className="flex-1">
        <ProjectHero
          title="Телегарам-бот для агентства недвижимости"
          subtitle="Мы разработали инновационное мини-приложение для агентства недвижимости, интегрированное напрямую в Telegram — мессенджер, где живут миллионы пользователей каждый день."
          imageSrc="/projects/GRE/01.webp"
          imageAlt="Скриншот интерфейса Miniapp Real Estate"
          year={2024}
          ...
          items={[
            {
              ...
              imageSrc: '/projects/GRE/06.webp',
              imageAlt: 'Скриншот интерфейса Miniapp',
              imageFit: 'cover',
              colSpanMd: 1,
            },
            {
        ...
        <ProjectOverview
          ...
          image={{ src: '/projects/GRE/01.webp', alt: 'Скриншоты Miniapp Real Estate' }}
          content={[
